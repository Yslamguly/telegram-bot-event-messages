...
const MY_CHAT = process.env.MY_CHAT
...
const sendDailyBookReadingPoll =  (bot)=>{
    ...
    cron.schedule(DAILY_READING_POLL_TIME,()=>{
        ...
        bot.sendPoll(MY_CHAT,`${currentDayOfTheMonth}  ${currentMonthOfTheYear} Feth suresi we 129 Ya Latifu okaldymy?`,['Hawa','Yok'],{is_anonymous:false})
